...
if($_SERVER['REQUEST_METHOD'] === 'POST'):
	...
	$inc =str_replace("_config", "_model", str_replace("Connection", "CompraRealizada", $inc));
	if(file_exists($inc)):
		include_once($inc);
	endif;
endif;
class CompraRealizadaController extends CompraRealizada
{
	public function __construct(){
		...
		if($_SERVER['REQUEST_METHOD'] === 'POST'):
			...
			switch (filter_input(INPUT_POST, "setting")) {
				...
				$_SESSION['products']['subtotal'] = filter_input(INPUT_POST, "subtotal");
